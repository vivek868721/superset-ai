<template>
  <div class="flex h-screen w-full overflow-hidden font-sans bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    ...
    <!-- Mobile Menu Button -->
    <button @click="isSidebarOpen = !isSidebarOpen" class="md:hidden fixed bottom-4 right-4 z-50 p-3 bg-indigo-600 text-white rounded-full shadow-lg">
    ...
    <!-- Sidebar / Chat Panel -->
    <div :class="[
      'absolute md:relative z-40 w-full sm:w-80 lg:w-96 h-full transition-transform duration-300 ease-in-out shrink-0',
